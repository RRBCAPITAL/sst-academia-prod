...
import { Box, TextField, Button, Grid, Typography, MenuItem, Select, FormControl, InputLabel, Checkbox, FormControlLabel, FormGroup, IconButton, InputAdornment } from '@mui/material';
...
const CreateUserForm = () => {
  ...
  useEffect(() => {
    const fetchCursos = async () => {
        const response = await apiClient.get('/courses'); // Ajusta el endpoint si es necesario
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      const res = await apiClient.post('/users', dataR, {
        headers: {
      ...
      await apiClient.post('/usuario-cursos', {
        userId: userId,
