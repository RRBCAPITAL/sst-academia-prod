    ...
    >
      ...
      >
        <Grid container spacing={4} alignItems="center" justifyContent="center" marginBottom="40px">
          ...
          <Grid size={{ xs: 12, md: 6 }} data-aos="fade-right" data-aos-delay="300">
            <Box
              component="img"
          ...
          {/* Texto a la derecha */}
          <Grid size={{ xs: 12, md: 6 }} data-aos="fade-left" data-aos-delay="600">
            <Typography
              variant="h4"
              sx={{
            ...
            <Typography
              variant="body1"
              sx={{ marginBottom: "40px", fontSize: "16px", textAlign: "left", color: 'white' }}
            >
            ...
            <Typography
              ...
              variant="body1"
              sx={{ color: 'white', marginBottom: { xs: "15px", md: "30px" }, fontSize: { xs: "14px", md: "20px", }, textAlign: "left" }}
            >
            ...
            <Typography
              ...
              variant="body1"
              sx={{ marginBottom: { color: 'white', xs: "15px", md: "30px" }, fontSize: { xs: "14px", md: "20px", }, textAlign: "left" }}
            >
            ...
            <Typography
              ...
              variant="body1"
              sx={{ fontSize: { color: 'white', xs: "14px", md: "20px", }, textAlign: "left" }}
            >
      ...
      <Box sx={{
        ...
        >
          ...
          <Grid size={{ xs: 12, md: 6 }} sx={{ alignItems: "center" }} data-aos="fade-left" data-aos-delay="400">
            <Typography
              variant="h4"
              sx={{
                fontWeight: "bold",
          ...
          <Grid size={{ xs: 12, md: 6 }} sx={{ marginTop: { xs: '30px', md: '0px' } }} data-aos="fade-right" data-aos-delay="800">
            <Box
              component="img"
        ...
        >
          ...
          {/* Texto a la derecha */}
          <Grid size={{ xs: 12, md: 6 }} data-aos="fade-left" data-aos-delay="400" sx={{ marginTop: '20px', paddingLeft: { md: '60px' } }}>
            <Typography
              variant="h4"
              sx={{
                fontSize: { xs: "30px", md: "36px" },
      ...
      <Box sx={{ maxWidth: "1200px", margin: 'auto', marginTop: { xs: '0px', md: "60px" }, padding: "40px 20px" }} data-aos="fade">
        ...
        <Grid container spacing={4} justifyContent="center">
          ...
          {/* Reseña 2 */}
          <Grid size={{ xs: 12, md: 4 }} data-aos="fade-up" data-aos-delay="600">
            <Paper
              elevation={3}
              sx={{
                padding: "30px",
          ...
          {/* Reseña 3 */}
          <Grid size={{ xs: 12, md: 4 }} data-aos="fade-up" data-aos-delay="900">
            <Paper
              elevation={3}
              sx={{
                padding: "30px",
      ...
      <Box sx={{ maxWidth: "1200px", margin: 'auto', marginTop: { xs: '10px', md: "60px" }, padding: "40px 20px" }}>
        ...
        <Grid container spacing={1} justifyContent="center">
          ...
          <Grid size={{ xs: 12, sm: 6 }} data-aos="fade-up" data-aos-delay="800">
            <Avatar
              src="/images/E4.png"
              alt="Empresa 4"
              sx={{
